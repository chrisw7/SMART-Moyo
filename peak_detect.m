...
filename = 'Accelerometer_20170228-182720191.csv';%best
...
% plot(t(z_locs),zv(z_locs),'vr',t,zv,'-b.')

%Plot example ZCV area of integration for xxx191.csv
...
%Plot ZCV example for xxx191.csv
if strcmp(filename,'Accelerometer_20170228-182720191.csv')
    ...
    zcv = -100*trapz(t(107:126),zv(107:126));
    fprintf('ZCV calculated depth:\t%0.3g cm\n', zcv)
    fprintf('Window-integrated depth:\t%0.3g cm\n', c_d(5))
    fprintf('Percent Difference:\t%0.3g%%\n', 100*abs(c_d(5)-zcv)/c_d(5))
end
